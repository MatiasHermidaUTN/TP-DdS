...
public class DatosPrueba {
    ...
    public static void cargarDatos() {
        //usuarios
        Usuario usr1 = new Usuario("usr1@mail.com", "Usuario 1", "passUsr1!");
        repoUsuario.guardar(usr1);

        Usuario usr2 = new Usuario("usr2@mail.com", "Usuario 2", "passUsr2!");
        repoUsuario.guardar(usr2);

        Usuario usr3 = new Usuario("usr3@mail.com", "Usuario 3", "passUsr3!");
        ...
        //perfiles
        Perfil prf1 = new Perfil("Perfil 1", comu1, TipoPerfil.NORMAL);
        ...
        Perfil prf2 = new Perfil("Perfil 2", comu2, TipoPerfil.NORMAL);
        ...
        Perfil prf3 = new Perfil("Perfil 3", comu3, TipoPerfil.NORMAL);
        ...
        //incidentes
        Incidente incidente1 = new Incidente(comu1, usr1, prestacion1, "Incidente 1");
        prestacion1.agregarIncidente(incidente1);
        repoIncidente.guardar(incidente1);

        Incidente incidente2 = new Incidente(comu2, usr2, prestacion2, "Incidente 2");
        prestacion2.agregarIncidente(incidente2);
        repoIncidente.guardar(incidente2);

        Incidente incidente3 = new Incidente(comu3, usr3, prestacion3, "Incidente 3");
        prestacion3.agregarIncidente(incidente3);
        repoIncidente.guardar(incidente3);

        Incidente incidente4 = new Incidente(comu1, usr2, prestacion4, "Incidente 4");
        prestacion4.agregarIncidente(incidente4);
        repoIncidente.guardar(incidente4);

        Incidente incidente5 = new Incidente(comu2, usr3, prestacion5, "Incidente 5");
        prestacion5.agregarIncidente(incidente5);
        repoIncidente.guardar(incidente5);

        Incidente incidente6 = new Incidente(comu3, usr1, prestacion1, "Incidente 6");
        prestacion1.agregarIncidente(incidente6);
        repoIncidente.guardar(incidente6);

        Incidente incidente7 = new Incidente(comu1, usr3, prestacion2, "Incidente 7");
        prestacion2.agregarIncidente(incidente7);
        repoIncidente.guardar(incidente7);

        Incidente incidente8 = new Incidente(comu2, usr1, prestacion3, "Incidente 8");
        prestacion3.agregarIncidente(incidente8);
        repoIncidente.guardar(incidente8);

        Incidente incidente9 = new Incidente(comu3, usr2, prestacion4, "Incidente 9");
