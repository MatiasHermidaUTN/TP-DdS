...
public class DatosPrueba {
    ...
    public void cargarDatos() {
        if(repoUsuario.buscarPorUsuarioYContrasenia("Usuario1", "passUsr1!") != null){
    ...
    public void cargaDatosGeoref() throws IOException {
        ...
        if (repoProvincia.buscarPorId(provincias.get(0).getId()) != null) {
            System.out.println("Los datos de georef estan cargados");
        } else {
